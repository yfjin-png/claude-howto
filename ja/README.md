...
| レベル | できること | ここから開始 | 時間 |
|-------|-----------|------------|------|
| **初心者** | Claude Code を起動してチャット | [スラッシュコマンド](01-slash-commands/) | 約 2.5 時間 |
| **中級者** | CLAUDE.md とカスタムコマンドを使用 | [スキル](03-skills/) | 約 3.5 時間 |
| **上級者** | MCP サーバーとフックを設定 | [高度な機能](09-advanced-features/) | 約 5 時間 |

**すべての 10 モジュールを含む完全な学習パス:**

| 順序 | モジュール | レベル | 時間 |
|-------|--------|-------|------|
| 1 | [スラッシュコマンド](01-slash-commands/) | 初心者 | 30 分 |
| 2 | [メモリ](02-memory/) | 初心者+ | 45 分 |
| 3 | [チェックポイント](08-checkpoints/) | 中級者 | 45 分 |
| 4 | [CLI 基本](10-cli/) | 初心者+ | 30 分 |
| 5 | [スキル](03-skills/) | 中級者 | 1 時間 |
| 6 | [フック](06-hooks/) | 中級者 | 1 時間 |
| 7 | [MCP](05-mcp/) | 中級者+ | 1 時間 |
| 8 | [サブエージェント](04-subagents/) | 中級者+ | 1.5 時間 |
| 9 | [高度な機能](09-advanced-features/) | 上級者 | 2～3 時間 |
| 10 | [プラグイン](07-plugins/) | 上級者 | 2 時間 |
...
| **スラッシュコマンド** | ユーザー起動型ショートカット | [01-slash-commands/](01-slash-commands/) |
| **メモリ** | 永続的なコンテキスト | [02-memory/](02-memory/) |
| **スキル** | 再利用可能な機能 | [03-skills/](03-skills/) |
| **サブエージェント** | 専門の AI アシスタント | [04-subagents/](04-subagents/) |
| **MCP プロトコル** | 外部ツールへのアクセス | [05-mcp/](05-mcp/) |
| **フック** | イベント駆動のオートメーション | [06-hooks/](06-hooks/) |
| **プラグイン** | バンドルされた機能 | [07-plugins/](07-plugins/) |
| **チェックポイント** | セッションスナップショット＆巻き戻し | [08-checkpoints/](08-checkpoints/) |
| **高度な機能** | 計画、思考、バックグラウンドタスク | [09-advanced-features/](09-advanced-features/) |
...
# または、プロジェクト .mcp.json に手動で追加（例については 05-mcp/ を参照）
```
